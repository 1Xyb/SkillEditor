...
namespace UnityEditor.GraphToolsFoundation.Overdrive.Tests.GraphElements
{
    public class TestEventHelpers
    {
...
#endif
            if (!InternalEditorUtility.isHumanControllingUs && Application.platform == RuntimePlatform.WindowsEditor)
            {
        ...
        // Clicking Helpers
        //-----------------------------------------------------------
        public void Click(Vector2 point, MouseButton mouseButton = MouseButton.LeftMouse, EventModifiers eventModifiers = EventModifiers.None)
        {
            MouseDownEvent(point, mouseButton, eventModifiers);
            MouseUpEvent(point, mouseButton, eventModifiers);
        }
        ...
        public void Click(VisualElement element, MouseButton mouseButton = MouseButton.LeftMouse, EventModifiers eventModifiers = EventModifiers.None)
        {
            Click(element.worldBound.center, mouseButton, eventModifiers);
        }
